...
description: "Quando o usuário quiser criar sales collateral, pitch decks, one-pagers, documentos de objection handling ou roteiros de demo. Use também quando o usuário mencionar 'sales deck,' 'pitch deck,' 'one-pager,' 'leave-behind,' 'objection handling,' 'deal-specific ROI analysis,' 'demo script,' 'talk track,' 'sales playbook,' 'proposal template,' 'buyer persona card,' 'help my sales team,' 'sales materials,' ou 'what should I give my sales reps.' Use isto para qualquer documento ou asset que ajude um time de vendas a fechar negócios. Para páginas de comparação de concorrentes e battle cards, veja competitor-alternatives. Para copy de site de marketing, veja copywriting. Para emails de cold outreach, veja cold-email."
metadata:
  version: 1.1.0
aliases: [sales-enablement]
