---
name: seo-image-gen
description: "Geração de imagens por IA para ativos de SEO: imagens de pré-visualização OG/social, imagens hero de blog, imagens de schema, fotografia de produto, infográficos. Alimentado por Gemini via nanobanana-mcp. Requer a extensão banana instalada. Use quando o usuário disser \"generate image\", \"OG image\", \"social preview\", \"hero image\", \"blog image\", \"product photo\", \"infographic\", \"seo image\", \"create visual\", \"image-gen\", \"favicon\", \"schema image\", \"pinterest pin\", \"generate visual\", \"banner\", ou \"thumbnail\"."
