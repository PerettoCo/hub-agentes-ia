---
name: social-content
description: "Quando o usuário quer ajuda para criar, agendar ou otimizar conteúdo de redes sociais para LinkedIn, Twitter/X, Instagram, TikTok, Facebook ou outras plataformas. Use também quando o usuário mencionar 'LinkedIn post,' 'Twitter thread,' 'social media,' 'content calendar,' 'social scheduling,' 'engagement,' 'viral content,' 'what should I post,' 'repurpose this content,' 'tweet ideas,' 'LinkedIn carousel,' 'social media strategy,' 'grow my following,' 'TikTok video,' 'Reels,' 'Shorts,' 'video script,' 'video hook,' 'short-form video,' ou 'create a reel.' Use para criação, reaproveitamento, agendamento de conteúdo de redes sociais e roteirização de vídeos de formato curto. Para estratégia de conteúdo mais ampla, veja content-strategy. Para anúncios de vídeo pagos, veja ad-creative."
metadata:
  version: 1.3.0
aliases: [social-content]
