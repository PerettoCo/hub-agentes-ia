...
description: "Quando o usuário quiser reduzir o churn, construir fluxos de cancelamento, configurar ofertas de retenção, recuperar pagamentos falhos ou implementar estratégias de retenção. Use também quando o usuário mencionar 'churn,' 'cancel flow,' 'offboarding,' 'save offer,' 'dunning,' 'failed payment recovery,' 'win-back,' 'retention,' 'exit survey,' 'pause subscription,' 'involuntary churn,' 'people keep canceling,' 'churn rate is too high,' 'how do I keep users,' ou 'customers are leaving.' Use sempre que alguém estiver perdendo assinantes ou quiser construir sistemas para evitá-lo. Para sequências de e-mail de win-back pós-cancelamento, veja email-sequence. Para paywalls de upgrade in-app, veja paywall-upgrade-cro."
metadata:
  version: 1.1.0
aliases: [churn-prevention]
